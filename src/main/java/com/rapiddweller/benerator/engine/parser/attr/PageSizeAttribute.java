...
/**
 * {@link AttributeInfo} for the 'pageSize' attribute falling back to the 'defaultPageSize' property
 * of the {@link com.rapiddweller.benerator.engine.BeneratorRootContext}.<br/><br/>
 * Created: 10.12.2021 19:33:54
 * @author Volker Bergmann
 * @since 2.1.0
 */
public class PageSizeAttribute extends AttributeInfo<Expression<Long>> {
